...
const AllShowsCard = ({ showDetails }) => {
    ...
    console.log("Show Details", showDetails.show)
    ...
    return (
        <div className='mx-auto '>
            <div className="card bg-base-100 shadow-2xl px-1 rounded-xl animation" data-aos="zoom-in">
                <figure><img src={image ? image.original : noImageFound } className='w-96 h-56 rounded-xl transition ease-out hover:ease-in delay-350 hover:scale-110 duration-300 ' alt="Movies" /></figure>
                <div className=" mt-2 px-2">
                    ...
                    <Link to={`/showDetails/${externals.thetvdb ? externals.thetvdb : 'noDataFound'}`}>
